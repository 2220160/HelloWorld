...
public class PreferencesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button saveBt = findViewById(R.id.saveButtom);
        Button cancelBt = findViewById(R.id.cancelButtom);
        Button resetBt = findViewById(R.id.resetButtom);
        //カレーごとにプレファレンスを分ける
        ...
        resetBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.apply();
                Toast.makeText(getApplicationContext(), "リセットしました", Toast.LENGTH_SHORT);
